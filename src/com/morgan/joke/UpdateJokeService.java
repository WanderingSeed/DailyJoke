...
public class UpdateJokeService extends Service {
	...
	private void updateWidget() {
		...
		view.setTextColor(R.id.joke_text,
				SettingActivity.getTextColor(UpdateJokeService.this));
		view.setFloat(R.id.joke_text, "setTextSize",
				SettingActivity.getTextSize(UpdateJokeService.this));
		view.setImageViewBitmap(R.id.joke_bg, ImageUtils.toRoundBitmap(
				SettingActivity.getBackgroundColor(UpdateJokeService.this), 16));
