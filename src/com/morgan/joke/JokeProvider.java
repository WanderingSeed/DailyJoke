...
public class JokeProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; i++) {
            ...
            views.setOnClickPendingIntent(R.id.nextjoke, PendingIntent.getService(context, UPDATE_WIDGET_REQUEST_CODE,
                    intent, PendingIntent.FLAG_CANCEL_CURRENT));
            intent = new Intent(context, LoadJokesService.class);
            views.setOnClickPendingIntent(R.id.loadjoke, PendingIntent.getService(context, LOAD_JOKE_REQUEST_CODE,
                    intent, PendingIntent.FLAG_CANCEL_CURRENT));
